...
public class FilmDAO implements Serializable{
	 ...
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	//private DystrybutorDAO dystrybutor;

	/** 
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the dystrybutor
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public DystrybutorDAO getDystrybutor() {
		// begin-user-code
		//return dystrybutor;
            return null;
		// end-user-code
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param theDystrybutor the dystrybutor to set
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public void setDystrybutor(DystrybutorDAO theDystrybutor) {
		// begin-user-code
		//dystrybutor = theDystrybutor;
		// end-user-code
	}
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param theTytul the tytul to set
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param theRokPremiery the rokPremiery to set
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param theOpisFabuly the opisFabuly to set
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
