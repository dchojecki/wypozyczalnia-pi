...
import wypozyczalniaklient.wizards.nowapozycja.PlytySorter;
import wypozyczalniaklient.wizards.nowapozycja.PlytyZbiorCP;
import wypozyczalniaklient.wizards.nowapozycja.PlytyZbiorCellModifier;
import wypozyczalniaklient.wizards.nowapozycja.PlytyZbiorLP;
	...
	public void createControl(Composite parent) {
		...
		filmy.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(Event arg0) {
				...
				if (plytyTO.zwrocWszystkiePlyty().size() > 0)
					plyta = plytyTO.zwrocWszystkiePlyty().iterator().next();
		...
		plyty = new TableViewer(danePlytGrupa);
		...
		editors[1] = new ComboBoxCellEditor(table, stany, SWT.READ_ONLY);
