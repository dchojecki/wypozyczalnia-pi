...
public class NoweZamowienieKontoPage extends WizardPage {
	...
	public NoweZamowienieKontoPage(ISelection selection) {
		super("wizardPage");
	...
	public void createControl(Composite parent) {
		...
		nrKontaCombo = new Combo(container, SWT.BORDER | SWT.SINGLE | SWT.READ_ONLY);
		gd = new GridData(GridData.FILL_HORIZONTAL);
	...
	private void updateStatus(String message) {
		...
		setPageComplete(message == null && sk != null && sk != StanKonta.ZABLOKOWANE);
	}
