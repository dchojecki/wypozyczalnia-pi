...
public class EntityManagerMock implements EntityManager {
	...
	private Integer lastKontoPracownikaId = 0;
	...
	public void persist(Object arg0) {
		...
		if (arg0 instanceof PracownikDAO) {
			...
			KontoPracownikaDAO konto = z.getKonto();
			if (z.getId() == null) {
				konto.setId(lastKontoPracownikaId++);
			}
			persisted.add(konto);
		}
		persisted.add(arg0);
		...
		if (arg0.equals(KlientDAO.class)) {
			...
			for (Object o : persisted) {
				if (o instanceof KlientDAO) {
					KlientDAO z = (KlientDAO) o;
					if (z.getNrpesel().equals(id)) {
						return (T) z;
					}
				}
			}
