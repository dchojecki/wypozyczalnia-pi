 ...
 *******************************************************************************/
package zarzadzaniewypozyczalnia.perspectives;
...
import zarzadzaniewypozyczalnia.views.ListaUzytkownikowWidok;
 ...
 *  to change. 
 */
public class ZarzadzanieKontamiPerspective implements IPerspectiveFactory {

	private IPageLayout factory;

	public ZarzadzanieKontamiPerspective() {
		super();
	}
	...
	private void addViews() {
		...
		IFolderLayout topLeft =
			factory.createFolder(
				...
				0.25f,
				factory.getEditorArea());
		topLeft.addView(ListaUzytkownikowWidok.ID);
